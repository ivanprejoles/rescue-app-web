              ...
              <Card className="overflow-hidden border-0.75 bg-black dark:shadow-[0px_0px_27px_0px_#2D2D2D] relative py-0 p-4">
                <GlowingWrapper>
                  <Card
                    ...
                    className="glass-effect p-12 text-center overflow-hidden border-0.75 bg-black dark:shadow-[0px_0px_27px_0px_#2D2D2D] relative"
                  >
                    <AnimatePresence>
                      {hovered && (
                        <motion.div
                    ...
                    <h2 className="text-4xl font-bold mb-4 z-20 text-white">
                      Download TERS Mobile App
                    </h2>
                    <p className="text-xl text-gray-300 z-20 mb-8 max-w-2xl mx-auto">
